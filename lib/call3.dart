...
class Call3 extends StatefulWidget {
  const Call3({Key? key}) : super(key: key);

  @override
  State<Call3> createState() => _Call3State();
}

class _Call3State extends State<Call3> {
        ...
        body: Center(
          child: Column(
            children: [
              ...
              const Text("08167714263", style: TextStyle(
                  color: Colors.white,
                  fontSize: 35
              ),),
